...
public class PagarFactura_GUI extends JFrame {
	...
	private List<Factura> facturasNoPagadas;
	...
	public PagarFactura_GUI() {
		...
		lblFactura.setBounds(20, 226, 170, 20);
		...
		botonConsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					numSocio = (Integer) comboBox.getSelectedItem();
					facturasNoPagadas = logicaNegocio.getFacturasNoPagadas(numSocio);
